...
function mtphr_shortcodes_admin_scripts( $hook ) {
	...
	wp_register_style( 'brankic', MTPHR_SHORTCODES_URL.'/assets/css/brankic.css', false, MTPHR_SHORTCODES_VERSION );
	wp_enqueue_style( 'brankic' );
...
function mtphr_shortcodes_footer_scripts() {
	...
	global $mtphr_post_slider, $mtphr_slide_graphs, $mtphr_tabs, $mtphr_toggles;
